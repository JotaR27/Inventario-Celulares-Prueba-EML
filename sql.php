...
/*--------------------------------------------------------------*/
/* funcion para  contar id  por tabla nombre
/*--------------------------------------------------------------*/
...
function tableExists($table){
 ...
 /*--------------------------------------------------------------*/
/* Login con los datos proveidos por $_POST,
 /* 
/*--------------------------------------------------------------*/
  ...
  /* viene del formulario login_v2.php.
  /* Si utilizó este método, elimine la función de autenticación.
 /*--------------------------------------------------------------*/
  ...
  / * Unirse a la tabla de usuarios y la tabla de usuario gropus------------------*/
